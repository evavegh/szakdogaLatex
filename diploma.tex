...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{Végh Éva}
\newcommand{\vikkonzulens}{Imre Gábor}
\newcommand{\vikcim}{Eseménykeresõ webalkalmazás fejlesztése\break Spring, Android és Angular\break felhasználásával}
...
\includeonly{
	...
	chapter2_feladatSpecifikacio,%
	chapter3_technologiak,%
	chapter4_tervezes,%
	chapter5_megvalositas,%
	chapter1,%
	chapter2,%
	chapter3,%
	acknowledgement,%
...
\include{chapter2_feladatSpecifikacio}
\include{chapter3_technologiak}
\include{chapter4_tervezes}
\include{chapter5_megvalositas}
%\include{chapter1}
%\include{chapter2}
%\include{chapter3}
